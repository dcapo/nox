...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.started_at'
        db.add_column('event', 'started_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 16, 0, 0)),
                      keep_default=False)

        # Adding field 'Event.creator'
        db.add_column('event', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='created_events', to=orm['nox.CustomUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.started_at'
        db.delete_column('event', 'started_at')

        # Deleting field 'Event.creator'
        db.delete_column('event', 'creator_id')
